...
public class RatingController {
    ...
    public ApiResponseNormal<Void> rateArticle(@PathVariable Integer articleId, @RequestBody RatingRequest ratingRequest) {
        String result = String.valueOf(ratingService.rateArticle(articleId, ratingRequest.getExpertId(), ratingRequest.getInnovationScore(), ratingRequest.getDisruptionScore(), ratingRequest.getFrontierScore(), ratingRequest.getIndustryImpactScore(), ratingRequest.getAdditionalScore()));
